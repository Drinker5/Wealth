    ...
    ICurrenciesRepository currenciesRepository) : IDbSeeder
{
    ...
    private async Task CreateBonds(CancellationToken token)
    {
        var bond1 = await bondsRepository.CreateBond(new CreateBondCommand
        {
            ...
            Nominal = new Money(CurrencyCode.Rub, 100m)
        }, token);
        ...
        var bond2 = await bondsRepository.CreateBond(new CreateBondCommand
        {
            ...
            Nominal = new Money(CurrencyCode.Rub, 1000m)
        }, token);
    ...
    private async Task CreateStocks(CancellationToken token)
    {
        var stock1 = await stocksRepository.CreateStock(new CreateStockCommand
        {
            Ticker = "IDX1",
            Name = "test-stock-1",
            Isin = new ISIN("000000000003"),
            Figi = new FIGI("000000000003"),
            InstrumentUId = new Guid("00000000-0000-0000-0000-000000000003"),
            LotSize = 10,
        ...
        var stock2 = await stocksRepository.CreateStock(new CreateStockCommand
        {
            Ticker = "IDX2",
            Name = "test-stock-2",
            Isin = new ISIN("000000000004"),
            Figi = new FIGI("000000000004"),
            InstrumentUId = new Guid("00000000-0000-0000-0000-000000000004"),
            LotSize = LotSize.One,
            Currency = CurrencyCode.Rub
        }, token);
    ...
    private async Task CreateCurrencies(CancellationToken token)
    {
        var currency1 = await currenciesRepository.CreateCurrency(new CreateCurrencyCommand
        {
            ...
            Figi = new FIGI("000000000006"),
            InstrumentUId = new Guid("00000000-0000-0000-0000-000000000006"),
            Currency = CurrencyCode.Rub
        }, token);
        ...
        var currency2 = await currenciesRepository.CreateCurrency(new CreateCurrencyCommand
        {
            ...
            Figi = new FIGI("000000000007"),
            InstrumentUId = new Guid("00000000-0000-0000-0000-000000000007"),
            Currency = CurrencyCode.Rub,
        }, token);
