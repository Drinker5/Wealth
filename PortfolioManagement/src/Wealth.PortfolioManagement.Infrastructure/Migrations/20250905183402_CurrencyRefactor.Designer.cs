...
namespace Wealth.PortfolioManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250905183402_CurrencyRefactor")]
            ...
            modelBuilder.Entity("Wealth.PortfolioManagement.Domain.Operations.BondTradeOperation", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Money", "Wealth.PortfolioManagement.Domain.Operations.BondTradeOperation.Money#Money", b1 =>
                        {
            ...
            modelBuilder.Entity("Wealth.PortfolioManagement.Domain.Operations.StockTradeOperation", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Money", "Wealth.PortfolioManagement.Domain.Operations.StockTradeOperation.Money#Money", b1 =>
                        {
                            b1.Property<decimal>("Amount")
                                .ValueGeneratedOnUpdateSometimes()
                                .HasColumnType("numeric");
