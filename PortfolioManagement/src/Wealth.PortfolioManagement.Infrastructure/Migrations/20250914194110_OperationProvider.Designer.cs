...
namespace Wealth.PortfolioManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250914194110_OperationProvider")]
    partial class OperationProvider
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wealth.PortfolioManagement.Domain.Operations.BondTradeOperation", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Wealth.PortfolioManagement.Domain.Operations.BondTradeOperation.Amount#Money", b1 =>
                        {
                    ...
                    b.ToTable("InstrumentOperations", t =>
                        {
                            t.Property("PortfolioId")
                                .HasColumnName("BondTradeOperation_PortfolioId");

                            t.Property("Type")
                                .HasColumnName("BondTradeOperation_Type");
                        });
            ...
            modelBuilder.Entity("Wealth.PortfolioManagement.Domain.Operations.StockTradeOperation", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Wealth.PortfolioManagement.Domain.Operations.StockTradeOperation.Amount#Money", b1 =>
                        {
                            b1.Property<decimal>("Amount")
                                .ValueGeneratedOnUpdateSometimes()
                                .HasColumnType("numeric");
                    ...
                    b.ToTable("InstrumentOperations", t =>
                        {
                            t.Property("PortfolioId")
                                .HasColumnName("StockTradeOperation_PortfolioId");

                            t.Property("StockId")
                                .HasColumnName("StockTradeOperation_StockId");

                            t.Property("Type")
                                .HasColumnName("StockTradeOperation_Type");
                        });
